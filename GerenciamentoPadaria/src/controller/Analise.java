...
public class Analise {
    ...
    private final DistribuicaoDeFrequencia distriDeFreque;
    private BigDecimal[][] tabela;
    private Informacoes informacoes;
    private final InformacoesDAO informacoesDAO;
    ...
    public void adicionarVariavelAoBanco(int id, String variavel) {
        ...
        String desconto = "0";
        produtoVendido = new ProdutoVendido(id, "12312312311", Data.getData(), 0, 1, variavel, desconto);
    ...
    public void gerarResultados(List<BigDecimal> list) {
        if(!list.isEmpty()) {
            ...
            throw new IllegalArgumentException("Lista de decimais vazia");
        }
    }
