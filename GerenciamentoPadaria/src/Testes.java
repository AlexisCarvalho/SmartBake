    ...
    public static void main(String[] args) {
        ...
        for (int a = 0; a < 5; a++) {
            ...
            try {
                ...
                System.out.println(fc.valorDescontado(a + 1));
                List<ProdutoVendido> produtoVendidoList = fc.getProdutoVendidoList();
                int idSumario = 0;
                String produto = "", produtosS = "";

                for(ProdutoVendido produtoVendido : produtoVendidoList){
                    idSumario++;
                    produto = idSumario + "- " + produtoVendido.getQuantidade() + "x  " + fc.getNomeProduto(produtoVendido.getIdProduto())
                            + ": " + produtoVendido.getValorPago().replace(".", ",") + "$\n";

                    produtosS = produtosS + produto;
                }
