...
public class Caixa extends JFrame {
    ...
    private Exit Exit;
    private final JTextField CodCliente;
    private final JTextField CodItem;
    private final JTextField Qnt;
    private final JTextField ValorT;
    private final JTextField ValorD;
    ...
    private final JTextField ValorPago;
    private final JTextField Troco;
    private BigDecimal valorJaPago;
    private final JTextArea sumario;
        ...
        PayButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    fc.sendToDB();
                    fc.atualizarDescontoClienteCompra();
                ...
                } catch (NumberFormatException tttt) {
                    System.err.println("Valor não reconhecido");
                }
            }
        });
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    ...
                    try {
                        ...
                        totalDesconto = new BigDecimal(fc.valorDescontado());
                        fc.closeConn();
                    ...
                    } catch (NumberFormatException valorn) {
                        System.err.println("Valor não reconhecido");
                    }
                }
            }
